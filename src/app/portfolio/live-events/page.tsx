...
const categoryTitle = "Live Events";
const categoryDescription = "From corporate functions and high-energy concerts to private parties and celebrations, we document the energy and key moments of any event with professionalism and a keen eye.";
...
export default function LiveEventsPage() {
  ...
  const photographsQuery = useMemoFirebase(() => {
    ...
    return query(collection(firestore, 'photographs'), where('category', '==', 'live-events'), orderBy('order'));
  }, [firestore]);
