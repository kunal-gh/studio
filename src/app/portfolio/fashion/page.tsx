...
const categoryTitle = "Fashion";
const categoryDescription = "Collaborating with designers and brands to create striking lookbooks, editorials, and campaign imagery that brings your collection to life with style and creativity.";
...
export default function FashionPage() {
  ...
  const photographsQuery = useMemoFirebase(() => {
    ...
    return query(collection(firestore, 'photographs'), where('category', '==', 'fashion'), orderBy('order'));
  }, [firestore]);
  ...
  return (
    <div className="py-20 md:py-28 lg:py-32 bg-background animate-in fade-in-50 duration-500">
        <div className="container mx-auto px-4">
            ...
            {!isLoading && images && images.length > 0 && <PortfolioGrid title="" images={images} layout="A" />}
