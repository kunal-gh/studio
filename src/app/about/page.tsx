                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6">
                            <h2 className="font-headline text-3xl font-bold">Hardik — The Eye Behind the Lens</h2>
                            ...
                            <p className="text-lg text-muted-foreground">
                                Inspired by the multifaceted perspectives of cubism and the emotional depth of Picasso's various eras, I strive to create images that are not just seen, but felt. Whether I'm capturing the raw energy of the streets, the intimate connection of a portrait, or the vibrant chaos of an event, my goal is to blend observation with emotion.
                            </p>
                             <p className="text-lg text-muted-foreground">
